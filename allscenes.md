...
- **Scene 9 (24 Sep 2026):** the hero is **Samudrappa (ಸಮುದ್ರಪ್ಪ)**, an original police officer: khaki Indian police uniform, peaked cap, long curly hair, a pistol raised in one hand and a lathi in the other. This replaces the peta-and-shawl Parva Hero described below. His name is on the base board and the fan banner reads "ಸಮುದ್ರಪ್ಪ ಅಭಿಮಾನಿಗಳ ಸಂಘ". He is drawn in code (SVG) as a stand-in until the painted cutout arrives. Counts use normal digits, milestone flags included (A5). On a phone the 10,000 thank-you sits on the fan banner, clear of the hero. The walk back into the hall is the lit "ದ್ವಿತೀಯಾರ್ಧ ಆರಂಭ" sign over the entrance; the fast push into the screen is not built yet.
