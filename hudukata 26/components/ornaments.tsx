...
function Flintlock({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 64 34"
      className={className}
...
export function CrossedFlintlocks({ className }: { className?: string }) {
  return (
    <span
      aria-hidden="true"
      className={cn('relative inline-flex items-center justify-center', className)}
    >
      <Flintlock className="w-full rotate-[-28deg] text-primary/80" />
      <Flintlock className="absolute w-full -scale-x-100 rotate-28 text-primary/60" />
      <span className="absolute size-2.5 rounded-full bg-primary shadow-[0_0_10px_2px_oklch(0.79_0.135_79/45%)]" />
    </span>
  )
}
...
export function DiamondBand({ className }: { className?: string }) {
  return (
    <div
      aria-hidden="true"
      className={cn(
