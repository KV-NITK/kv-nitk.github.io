...
const TeamRegistration = () => {
  ...
  // ----------------------------------------------
  // User already belongs to a registered squad
  // ----------------------------------------------
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="border-b-2 border-[#8b5a2b]/30 pb-4 text-center">
          ...
          <p className="mt-2 font-serif text-xs sm:text-sm tracking-wider text-[#7a4823]">
            STATUS: <span className="font-bold text-emerald-800 uppercase bg-emerald-900/10 px-2 py-0.5 rounded border border-emerald-800/30">{userTeam.status || "REGISTERED"}</span>
          </p>
        </div>
        ...
        <div className="border border-amber-900/30 bg-amber-900/10 p-4 text-center font-serif text-xs sm:text-sm text-[#4a2206] rounded-sm leading-relaxed">
          🏴‍☠️ <strong>Registration Confirmed!</strong> You are registered for <strong>Hudugata Hudakata 2026</strong>. Below are your official squad details.
        </div>
        ...
        <div className="border-2 border-[#7a4823]/40 bg-[#fffdf9] p-5 rounded-sm shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-[#2b1810]">
            <div>
              <span className="font-serif text-xs text-[#7a4823]/80 block uppercase tracking-wider">IRIS ID / Roll No</span>
              <strong className="font-mono text-base">{userTeam.leader.rollNo || userTeam.leader.irisId}</strong>
            </div>
            <div>
              <span className="font-serif text-xs text-[#7a4823]/80 block uppercase tracking-wider">Current Account</span>
              <strong className="font-sans text-base">{user?.name || "IRIS Leader"} ({user?.email})</strong>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="font-serif text-xs font-bold uppercase tracking-[0.18em] text-[#7a4823] border-b border-[#7a4823]/20 pb-2">
            Squad Members ({userTeam.members.length + 1} Total Hunters)
          </h3>
            ...
            {userTeam.members.map((member, index) => (
              ...
              >
                <div className="flex flex-col gap-0.5">
                  ...
                  <p className="text-xs text-[#5c3418]">
                    {member.email}
                  </p>
                </div>
