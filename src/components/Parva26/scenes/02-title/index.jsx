...
import { TitleCard } from '@p26/scenes/02-title/title-card'
import { ShowBoard } from '@p26/scenes/02-title/show-board'
import { SeatRow } from '@p26/scenes/02-title/seat-tickets'
import { NameBoard } from '@p26/scenes/02-title/name-board'
import { Proscenium } from '@p26/scenes/02-title/proscenium'
import { TheatreWalls } from '@p26/scenes/02-title/theatre-walls'
import { Audience } from '@p26/scenes/02-title/audience'
import { anchorStrip } from '@p26/chrome/subtitle-strip'
import { createForest } from '@p26/scenes/02-title/forest'
import { createAir } from '@p26/scenes/02-title/air'
