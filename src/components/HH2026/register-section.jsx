    ...
    <section id="register" className="relative border-b border-primary/15 bg-parchment">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center gap-7 px-5 py-20 text-center">
        ...
        <p className="max-w-xl text-lg leading-relaxed text-muted-foreground text-pretty">
          Entry is free for NITK students. Squads of 3 to 4 (must contain at least <strong>1 Kannadiga</strong> and at least <strong>1 Non-Kannadigas</strong>). Slots are capped — once they're gone, the trail closes.
        </p>
